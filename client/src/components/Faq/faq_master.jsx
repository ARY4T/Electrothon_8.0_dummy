const initialQues = [
    {
      title: "Will the travel and food + accommodation charges be covered by the hackathon organizers?",
      content: "There will be no travel reimbursements provided to the hackathon attendees. But we will take care of your food and accommodation.",
    },
    {
      title: "Who can apply?",
      content: "You must be at least 18 years old and enrolled at any designated university or college.",
    },
    {
      title: "What if I've never been to a hackathon before?",
      content: "We require simply that you be curious and enthusiastic to join us on this voyage. We'll have talks, mentors, and workshops to help you with your project and figure things out.",
    },
    {
      title: "Do I need experience?",
      content: "No, you do not require any prior experience in development. We will provide you with mentors from the Homo Sapiens species to help you figure stuff out. Of course, a will to think, learn, and collaborate will be the cherry on top.",
    },
    {
      title: "What are the selection criteria?",
      content: "Evaluation criteria will include the novelty of the idea, complexity, clarity, and details in the prescribed format, feasibility, practicability, sustainability, the scale of impact, the user experience, and the potential for future prospects.",
    },
    {
  ...
  const moreQues = [
    {
      ...
      content: "There is no limitation in this case. We also welcome a team full of Homo Sapiens from various backgrounds or institutions.",
    },
    {
